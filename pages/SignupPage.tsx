  ...
  return (
    <div className="min-h-screen bg-gradient-dark text-gray-200 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        {/* Welcome Section */}
        <h1 className="text-4xl font-bold text-white mb-2 font-heading">Create Your Account</h1>
        <p className="text-gray-400 mb-8">Join us on your spiritual learning journey</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start">
            <input
              ...
              className="mt-1 mr-2 w-4 h-4 text-brand-orange border-gray-600 rounded focus:ring-brand-orange"
            />
